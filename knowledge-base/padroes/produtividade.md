...
- **Foto: canto SUPERIOR-ESQUERDO RETO**, demais cantos raio **48** (medido) — borderRadius '0 48px 48px 48px'.
- **Bold 600** (global via TextoRico — MEDIDO: stroke 9px como o modelo; live-rule bold-600-global).
- **Bloco preto do fecho = FLUTUANTE** (não embutido na foto): x **40→94.4%** — sai da foto na borda INFERIOR (~metade) E na LATERAL DIREITA (~3.8%); raio 28 em 3 cantos e canto SUPERIOR-ESQUERDO RETO — '0 28 28 28', espelhando a foto (regra Patrick 2026-07-16). Foto H **45%** (bottom 72.5% no modelo).
