...
OFICIAL_META = {
    ...
    "selo-14anos-1": {"tipo": "selo-aniversario", "cor": "badge amarelo manga #F7BE35 + glifo grafite", "usar_sobre": ["amarelo (PADRÃO do projeto — tom-sobre-tom intencional)", "grafite", "branco", "foto"], "evitar_sobre": [], "uso": "Selo 14 anos COM badge manga (= SELO 14 ANOS-12 do ZIP). VERSÃO PADRÃO do projeto — usar esta inclusive sobre fundo amber (badge tom-sobre-tom é intencional; correção Patrick 2026-07-16). Confirmado em uso 2026."},
